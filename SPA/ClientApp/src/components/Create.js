...
export class Create extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            userPhone: "",
            userPassword: "",
            canSubmitArray: [false, false, true, false],
            canSubmit: false
        }
    }
    ...
    async loadCategoriesFromServer() {
        ...
        this.setState({ cat: data.categories, sub: catSubcat, chosenCategory: data.categories[0].name });
    }
    ...
    changePassword(e) {
        ...
        if (e.target.value.match(passwordFormat)) {
            this.changeCanSubmit(true, 3)
            e.target.style.borderBottom = "4px solid #4caf50"
        }
        else {
            this.changeCanSubmit(false, 3)
            e.target.style.borderBottom = "4px solid #f44336"
        }
        this.setState({
    ...
    async addUser(e) {
        ...
        if (!this.state.canSubmit) {
            this.props.addAlert("Nice try hacker. Think again", "dark")
            return
        }
        const data =  {
            ID: 0,
            Name: this.state.userName,
            Surname: this.state.userSurname === "" ? null : this.state.userSurname,
            Email: this.state.userEmail,
            Password: this.state.userPassword,
            Category: this.state.chosenCategory,
            Subcategory: this.state.chosenSubcategory != "" ? this.state.chosenSubcategory : null,
            PhoneNumber: this.state.userPhone === "" ? null : this.state.userPhone,
            Birth: this.state.userBirth === "" ? null : this.state.userBirth
        }
        await fetch("user/create", {
            ...
            throw Error("Something went wrong while creating contact. Check entered data")
        }
        ).catch((error) => {
                        ...
                        <div className="col-lg-8 col-xl-6">
                            <div className="card rounded-3">
                                ...
                                <div className="card-body p-4 p-md-5">
                                    ...
                                    <form className="px-md-2" autoComplete="true">

                                        <div className="row">
                                            <div className="form-outline col-md-6 mb-4">
                                                <input type="text" id="form3Example1q" className="form-control" onChange={this.changeName.bind(this)} value={this.state.userName} required/>
                                                <label className="form-label" htmlFor="form3Example1q">Name<span>*</span></label>
                                            </div>
                                            <div className="form-outline col-md-6 mb-4">
                                                <input type="text" id="form3Example2q" className="form-control" onChange={this.changeSurname.bind(this)} value={this.state.userSurname} />
                                        ...
                                        <div className="row">
                                            <div className="form-outline col-md-6 mb-4">
                                                <input type="text" id="form3Example3q" className="form-control" onChange={this.changeEmail.bind(this)} value={this.state.userEmail} required/>
                                                <label className="form-label" htmlFor="form3Example3q">Email<span>*</span></label>
                                            </div>
                                            <div className="form-outline col-md-6 mb-4">
                                                <input type="text" id="form3Example7q" className="form-control" onChange={this.changePhone.bind(this)} value={this.state.value}/>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6 mb-4">
                                                <select className="select" id="form3Example21q" onChange={this.changeCategoryType.bind(this)} value={this.state.chosenCategory}>
                                                    {this.state.cat.map(item => (
                                                        <option value={item.name} key={item.name}>{item.name}</option>
                                                    ))}
                                                </select>
                                                <label className="form-label" htmlFor="form3Example21q">Category<span>*</span></label>
                                            </div>
                                            <div className="col-md-6 mb-4">
                                        ...
                                        <div className="row">
                                            <div className="form-outline col-md-6 mb-4">
                                                <input type="date" id="form3Example4q" className="form-control" value={this.state.userBirth} onChange={this.changeBirth.bind(this)} />
                                                <label className="form-label" htmlFor="form3Example4q">Birth</label>
                                            </div>
                                            <div className="form-outline col-md-6 mb-4">
                                                <input type="password" id="form3Example410" className="form-control" value={this.state.userPassword} onChange={this.changePassword.bind(this)} required autoComplete="true" name="password" />
                                                <label className="form-label" htmlFor="form3Example10q">Password<span>*</span></label>
                                            </div>
                                        </div>
                                        

                                        <button type="submit" disabled={!this.state.canSubmit} className="btn btn-success btn-lg mb-1" onClick={this.addUser.bind(this)}>Submit</button>
